...
Mesh SpringEngine::Graphics::MeshBuilder::CreateGroundPlane(uint32_t numRows, uint32_t numCols, float spacing)
{
	Mesh mesh;
...
Mesh SpringEngine::Graphics::MeshBuilder::CreateSphere(uint32_t slices, uint32_t rings, float radius)
{
	Mesh mesh;
