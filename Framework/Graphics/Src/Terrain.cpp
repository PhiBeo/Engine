...
void SpringEngine::Graphics::Terrain::Initialize(const std::filesystem::path& fileName, float heightScale)
{
	FILE* file = nullptr;
...
float SpringEngine::Graphics::Terrain::GetHeight(const Math::Vector3& position) const
{
